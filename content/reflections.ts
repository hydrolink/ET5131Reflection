...
export const siteContent: SiteContent = {
  hero: {
    heading: "Reflections by the Fire",
    subtitle:
      "A journey through ET5131 — Entrepreneurship & Innovation",
  ...
  about: {
    ...
    paragraphs: [
      ...
      "This space is a personal reflection on my journey through ET5131 — Entrepreneurship and Innovation. It is not just a summary of what was taught, but a window into how those lessons shaped my thinking, challenged my assumptions, and helped me discover parts of myself I had not fully explored.",
